                 ...
                 enum keySize size)
{
	...
	std::cout << "Time taken by expandKey: " << duration.count() << " microseconds" << std::endl;    
	...
	std::cout << "Time taken by encrypt: " << duration.count() << " microseconds" << std::endl;
